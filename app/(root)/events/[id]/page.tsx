  ...
  return (
    <>
      <section className="flex justify-center bg-dotted-pattern bg-contain">
        <div className="grid grid-cols-1 md:grid-cols-2 2xl:max-w-7xl mt-4">
          <div className="">
            <Image
              src={event.imageUrl}
              alt="hero image"
          ...
          <div className="flex w-full flex-col gap-8 p-5 md:p-10 dark:text-white">
            ...
            <div className="flex flex-col gap-2">
              <p className="p-bold-20 text-grey-600 dark:text-slate-400">
                What You'll Learn:
              </p>
