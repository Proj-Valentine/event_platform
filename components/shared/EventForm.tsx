...
//   form validation usong the validator library
...
//   handle form submission, what to do with the values
    ...
    // create event and store in database
     if (type === "Create") {
       try {
         ...
         // reset form after creating an event and navigate to the event page using the router
         if (newEvent) {
           form.reset();
