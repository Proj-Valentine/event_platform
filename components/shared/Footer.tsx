...
const Footer = () => {
  ...
  return (
    // <footer classNameName="border-t">
    //   <div classNameName="flex-center wrapper flex-between flex flex-row gap-4 p-5 text-center sm:flex-row">
    //     <Link href="/">
    //       <Image
    ...
    //     <p>2023 Streamfy. All Rights reserved.</p>
    //   </div>
    // </footer>
